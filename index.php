   ...
   <!--<header class="short-header">   
	   ...
	   <!--	<nav id="main-nav-wrap">
				<ul class="main-navigation sf-menu">
					...
					<!--</li>-->
				<!--	<li class="has-children">
						<a href="universidade/universidade.html" title="">Universidade</a>-->
						<!-- <ul class="sub-menu"> -->
			            <!-- <li><a href="single-video.html">Video Aulas</a></li>
			            <li><a href="single-audio.html">Galeria</a></li> -->
			            <!--<li><a href="single-gallery.html">Gallery Post</a></li>-->
			            <!--<li><a href="single-standard.html">Standard Post</a></li>-->
			        <!--  </ul> -->
				<!--	</li>
					<li><a href="style-guide.html" title="">Styles</a></li>
					<li><a href="about.html" title="">Desenvolvimento</a></li>	
                    <li><a href="about.html" title="">Desenvolvimento</a></li>	
					<li><a href="contact.html" title="">Suporte</a></li>										
				</ul>
			</nav> -->
			...
			<!--<div class="search-wrap">
				...
				<form role="search" method="get" class="search-form" action="#">
					<label>
						...
						<input type="search" class="search-field" placeholder="O que procura?" value="" name="s" title="Search for:" autocomplete="off">
					</label>
				   			...
				   			<li>
				   				<div class="featured-post-slide">
								   	...
								   	<div class="post-content">
								   		<ul class="entry-meta">
												<li>Fevereiro 26, 2019</li> 
												<li><a href="#" >Nasce o sistema de Intranet</a></li>				
											</ul>	

								   		<h1 class="slide-title"><a href="single-standard.html" title="">Agora você conta com o mais novo sistema de Intranet Global</a></h1> 
								   	</div> 				   					  
				   			 ...
				   			 <li>
				   				<div class="featured-post-slide">
								   	...
								   	<div class="post-content">
								   		<ul class="entry-meta">
												<li>Fevereiro 26, 2019</li>
												<li><a href="#">A Universidade Global</a></li>					
											</ul>	

								   		<h1 class="slide-title"><a href="single-standard.html" title="">Aprenda, agora você conta com mais um recurso inovador para nossa empresa.</a></h1>
						   			</div>		   				   					  
         	...
         	<article class="brick entry format-standard animate-this">
              ...
              <div class="entry-thumb">
                  <a href="single-standard.html" class="thumb-link">
	                  <img src="images/thumbs/vasco.jpg" alt="building">             
                  </a>
               </div>
               	...
               	<div class="entry-header">
               		...
               		<div class="entry-meta">
               			<span class="cat-links">
               				<a href="#">Notícia</a> 
               				<!-- <a href="#">Editor Vander</a> -->               				
               			</span>			
               		</div>

               		<h1 class="entry-title"><a href="single-standard.html">Global fecha parceria com o Clube Vasco.</a></h1>
               		
               	</div>
						<div class="entry-excerpt">
							Uma conquista importante foi alcançada por nos, a nossa empresa GLOBAL CLUBE DE BENEFICIOS DO BRASIL fecha uma parceria com o clube Vasco da Gama de futebol. <a href="/ads/single-standard.html">Veja mais...</a> .
						</div>
               </div> 
            ...
            <article class="brick entry format-standard animate-this">
               ...
               <div class="entry-text">
               	<div class="entry-header">
               		...
               		<h1 class="entry-title"><a href="single-standard.html">Global abre parceria de ajuda a Creche.</a></h1>
               		
               	</div>
						<div class="entry-excerpt">
							Nossa empresa sempre focada em ajudar nossa comunidade, agora conta com mais uma parceria de peso.<a href="/ads/single-standard.html">Veja mais...</a>.
						</div>
               </div> 
   		...
   		<div class="row">  
	      	...
	      	<div class="col-four tab-full mob-full footer-info">            
	            ...
	            <h4>About Our Site</h4>
	               ...
	               <p>
		          	Nosso mais novo serviço de intranet promete centralizar as informações da empresa e colocar a diretoria mais próxima de vocês.
		          	</p>
	      	...
	      	<div class="col-two tab-1-3 mob-1-2 site-links">
	      		...
	      		<ul>
	      			<li><a href="#">Nossa Intranet</a></li>
						<li><a href="#">Universidade Global</a></li>
						<li><a href="#">Comunicado Global</a></li>
	      	...
	      	<div class="col-four tab-1-3 mob-full footer-subscribe">
	      		...
	      		<p>Não deixem de acompanhar nossas notícias.</p>
      ...
      <div class="footer-bottom">
      	<div class="row">
      		...
      		<div class="col-twelve">
	      		<div class="copyright">
		         	<span>© Copyright TI Global</span> 
		         	<span>Design by Vander e Raphael</span>		         	
		         </div>
